...
class TestCaptureHandler(unittest.TestCase):
    ...
    def test_should_return_false_if_target_pawn_is_none(self):
        self.capture_handler.__get_opponent = MagicMock(return_value=None)
    ...
    def test_get_opponent_should_return_opponent_if_found(self, mock_isinstance):
        ...
        self.assertEqual(self.capture_handler.__get_opponent(self.pawn, self.new_pos), (opponent, self.new_pos))
    ...
    def test_get_opponent_should_return_none_if_out_of_bounds(self):
        ...
        self.assertIsNone(self.capture_handler.__get_opponent(self.pawn, self.new_pos))
