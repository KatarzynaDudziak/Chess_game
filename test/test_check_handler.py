...
class TestCheckHandler(unittest.TestCase):
    ...
    def test_return_black_color_if_white_pawn_can_make_a_check(self):
        ...
        self.check_handler.__can_make_a_check = MagicMock(return_value=True)

        self.assertEqual(self.check_handler.get_checked_king_color(check_whose_turn), Color.BLACK)
        self.check_handler.__can_make_a_check.assert_called_once_with(self.board.white_pawns, Color.WHITE)
    ...
    def test_return_white_color_if_black_pawn_can_make_a_check(self):
        ...
        self.check_handler.__can_make_a_check.assert_called_once_with(self.board.black_pawns, Color.BLACK)

    def test_return_none_if_no_pawn_can_make_a_check(self):
        check_whose_turn = MagicMock(return_value=Color.WHITE)
        self.board.white_pawns = [(self.pawn, self.position)]
        self.check_handler.__can_make_a_check = MagicMock(return_value=False)

        self.assertIsNone(self.check_handler.get_checked_king_color(check_whose_turn))
        self.assertEqual(self.check_handler.__can_make_a_check.call_count, 2)

    def test_should_return_white_color_if_is_black_turn_and_black_pawn_can_make_a_check(self):
        check_whose_turn = MagicMock(return_value=Color.BLACK)
        self.board.white_pawns = [(self.pawn, self.position)]
        self.board.black_pawns = [(self.pawn, self.position)]
        self.check_handler.__can_make_a_check = MagicMock(side_effect=[False, True])

        self.assertEqual(self.check_handler.get_checked_king_color(check_whose_turn), Color.WHITE)
        self.check_handler.__can_make_a_check.assert_has_calls([call(self.board.white_pawns, Color.WHITE),
    ...
    def test_should_return_black_color_if_is_white_turn_and_white_pawn_can_make_a_check(self):
        ...
        self.assertEqual(self.check_handler.get_checked_king_color(check_whose_turn), Color.BLACK)
        self.check_handler.__can_make_a_check.assert_has_calls([call(self.board.black_pawns, Color.BLACK),
    ...
    def test_should_return_false_if_can_escape_check(self):
        ...
        self.check_handler.__can_escape_check = MagicMock(return_value=True)
        ...
        self.check_handler.__can_escape_check.assert_called_once_with(self.pawn, self.position, self.check_whose_turn)

    def test_should_return_true_if_cannot_escape_check(self):
        pawns_list = [(self.pawn, self.position)]
        self.board.get_piece = MagicMock(return_value=self.pawn)
        self.check_handler.__can_escape_check = MagicMock(return_value=False)
    ...
    def test_should_return_true_if_pawn_can_move(self, mock_point, mock_range):
        ...
        self.assertTrue(self.check_handler.__can_escape_check(self.pawn, self.position, self.check_whose_turn))
    ...
    def test_should_return_False_if_pawn_cannot_move_or_capture(self, mock_point, mock_range):
        ...
        self.assertFalse(self.check_handler.__can_escape_check(self.pawn, self.position, self.check_whose_turn))
    ...
    def test_should_return_true_if_can_capture_king(self):
        ...
        self.check_handler.__can_capture_king = MagicMock(return_value=True)

        self.assertTrue(self.check_handler.__can_make_a_check(pawns_list))
        
        self.check_handler.__can_capture_king.assert_called_once_with(self.pawn, self.position, king_pos)
    ...
    def test_should_return_false_if_cannot_capture_king(self):
        ...
        self.board.get_piece = MagicMock(return_value=self.pawn)
        self.board.get_king_position = MagicMock(return_value=king_pos)
        self.check_handler.__can_capture_king = MagicMock(return_value=False)

        self.assertFalse(self.check_handler.__can_make_a_check(pawns_list))
    ...
    def test_should_return_false_if_king_position_is_none(self):
        ...
        self.check_handler.__can_capture_king = MagicMock()

        self.assertFalse(self.check_handler.__can_make_a_check(pawns_list))
        
        self.board.get_king_position.assert_called_once_with(self.pawn)
        self.check_handler.__can_capture_king.assert_not_called()
    ...
    def test_should_return_false_if_pawns_list_is_empty(self):
        ...
        self.assertFalse(self.check_handler.__can_make_a_check(pawns_list, pawns_color=Color.WHITE))
    ...
    def test_should_return_true_if_knight_can_capture_king(self, mock_isinstance):
        ...
        self.assertTrue(self.check_handler.__can_capture_king(knight, self.position, king_pos))
    ...
    def tets_should_return_true_if_pawn_can_capture_king(self, mock_isinstance):
        ...
        self.assertTrue(self.check_handler.__can_capture_king(self.pawn, self.position, king_pos))
    ...
    def test_should_return_false_if_piece_cannot_capture_king(self, mock_isinstance):
        ...
        self.assertFalse(self.check_handler.__can_capture_king(self.pawn, self.position, king_pos))
